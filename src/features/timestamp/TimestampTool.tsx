        ...
        <div className="h-full flex flex-col gap-6">
            ...
            <div className="flex flex-wrap gap-2">
                <button
                    ...
                    className="px-4 py-2 bg-[var(--accent-color)] hover:bg-[var(--accent-hover)] text-white rounded-lg font-medium transition-colors btn-hover-effect inline-flex items-center gap-2"
                >
